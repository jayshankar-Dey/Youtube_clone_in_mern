...
const History_Video = ({vedio,deleteHistory}) => {
   // console.log(vedio)
  return (
    <div className="flex text-zinc-300 border gap-x-2 border-zinc-700 lg:h-52 h-40 px-2 bg-zinc-900 rounded">
       ...
       <div>
        <div className="flex justify-between gap-x-3 ">
            ...
            <button onClick={()=>deleteHistory(vedio?._id)} className="text-3xl w-7 "><ion-icon name="close"></ion-icon></button>
        </div>
